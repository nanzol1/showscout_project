                                ...
                                <div class="row">
                                    <div class="col-6 text-center">
                                        <div class="form-group">
                                            <input type="text" id="validationCustom01" name="first_name" id="first_name" placeholder="Vezetéknév" required>
                                        </div>
                                    </div>
                                    <div class="col-6 text-center">
                                        <div class="form-group">
                                            <input type="text" name="last_name" id="validationCustom01" id="last_name" placeholder="Keresztnév" required>
                                        </div>
                                    </div>
