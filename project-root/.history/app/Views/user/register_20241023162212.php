                                ...
                                <div class="row">
                                    <div class="col-6 text-center">
                                        <div class="form-group">
                                            <input type="text" name="first_name" id="first_name" placeholder="Vezetéknév">
                                        </div>
                                    </div>
                                    <div class="col-6 text-center">
                                        <div class="form-group">
                                            <input type="text" name="last_name" id="last_name" placeholder="Keresztnév">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 text-center">
                                        <div class="form-group">
                                            <input type="text" name="password" id="password" placeholder="Jelszó">
                                        </div>
                                    </div>
                                    <div class="col-6 text-center">
                                        <div class="form-group">
                                            <input type="text" name="password2" id="password2" placeholder="Keresztnév">
                                        </div>
                                    </div>
