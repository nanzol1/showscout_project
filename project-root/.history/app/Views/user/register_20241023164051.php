                        ...
                        <div class="col-12">
                            <form action="<?=base_url('regUser')?>" method="POST" id="reglog_form" class="needs-validation" novalidate>
                                <div class="row">
                                    ...
                                    <div class="col-6 text-center">
                                        <div class="form-group">
                                            <input type="password" name="password" id="password" class="form-control" id="validationCustom01" id="password" placeholder="Jelszó" required>
                                        </div>
                                    </div>
                                    <div class="col-6 text-center">
                                        <div class="form-group">
                                            <input type="password" name="password2" id="password2" class="form-control" id="validationCustom01" id="password2" placeholder="Jelszó 2x" required>
                                        </div>
                                    </div>
        ...
        addEventListener('DOMContentLoaded', (e) =>{
            ...
            logreg_form.addEventListener("change", (e) => {
                ...
                if(!password.value.match(regExp) || password.value != password2.value){
                    ...
                    logreg_form.classList.add('was-validated')
