...
class Admin extends BaseController{
    ...
    public function createMedia(){
        $mediaModel = new Media_model();
        $formData = [];
        $img = $this->request->getFile('film_img');
        var_dump($img);
        if($this->request->getMethod() === "POST"){
            ...
            $validationRule = [
                'film_img' => [
                    ...
                    'rules' => [
                        'uploaded[film_img]',
                        'is_image[film_img]',
                        'mime_in[film_img,image/jpg,image/jpeg,image/gif,image/png,image/webp]',
                        'max_size[film_img,100]',
                        'max_dims[film_img,3000,3000]',
                    ],
                ],
            ];
            ...
            /*if (!$img->hasMoved()) {
                $filepath = WRITEPATH . 'images/' . $img->store();
