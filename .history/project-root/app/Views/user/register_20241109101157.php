                  ...
                  <form action="<?=base_url('/regUser')?>" method="POST" id="reglog_form">
                     <div class="form-row">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" id="validationCustom02" name="last_name"placeholder="Keresztnév">
                        </div>
                     </div>
                     <div class="form-row">
                        <div class="form-group">
                           <label for="validationCustom03" id="warning-label-username" class="warning-label">Felhasználónév</label>
                           <input type="text" id="validationCustom03" name="first_name"placeholder="Felhasználónév">
                        </div>
                        <div class="form-group">
                           <label for="validationCustom04" id="warning-label-email" class="warning-label">Email</label>
                           <input type="email" id="validationCustom04" name="username"placeholder="example@example.com">
                        </div>
                     </div>
                     <div class="form-row">
                        <div class="form-group">
