               ...
               <div class="sidebar">
                  ...
                  <div class="form-card">
                     ...
                     <form action="<?=base_url('admin/createMedia')?>" method="POST">
                        ...
                        <input type="text" id="film-title" name="title" placeholder="Film címe">
                        <label for="film-url">Film URL:</label>
                        <input type="text" id="film-url" name="url" placeholder="Film URL">
                        <label for="film-description">Film leírása:</label>
                        <textarea id="film-description" name="desc" placeholder="Film leírása"></textarea>
                        <label for="film-image">Film kép feltöltése:</label>
                        <input type="file" id="film-image" name="img" accept="image/*">
                        <button type="submit">Létrehozás</button>
                     </form>
                  </div>
               </div>
